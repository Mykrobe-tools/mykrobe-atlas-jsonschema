...
var Patient = {
  ...
  properties: {
    ...
    injectingDrugUse: {
      ...
      type: "string",
      enum: ["Yes", "No"],
      synonyms: ["Yes, Injecting Drug Use, Drug User, Drug Use, Drug Abuse, Injecting Drug Use"]
    },
    homeless: {
      title: "Homeless",
      type: "string",
    ...
    diabetic: {
      ...
      synonyms: ["Diet alone, Diabetic, Diabetes", "Tablets, Diabetic, Diabetes", "Insulin, Diabetic, Diabetes", "Insulin+tablets, Diabetic, Diabetes"]
    },
    hivStatus: {
      title: "HIV Status",
      type: "string",
